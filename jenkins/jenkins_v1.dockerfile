...
# Jenkins Customization For Security
   ...
   # TODO
   wget -O /var/lib/jenkins/users/chefadmin/config.xml https://github.com/DennyZhang/devops_docker_image/raw/tag_v2/jenkins/reousrces/chefadmin_conf_xml && \
   ...
   wget -O /var/lib/jenkins/config.xml https://github.com/DennyZhang/devops_docker_image/raw/tag_v2/jenkins/reousrces/jenkins_conf_xml && \
